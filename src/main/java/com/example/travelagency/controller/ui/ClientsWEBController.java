...
public class ClientsWEBController{
    ...
    private List<Clients> clients = new ArrayList<>(
            Arrays.asList(
                    ...
                    new Clients(2 , "Ebola" , "delain" , "Maksymovch" , "backer-street" , "0665393661"),
                    new Clients(3 , "Max" , "ilichuk" , "Valeriovych" , "mehanizatoriv" , "0655480158"),
                    new Clients(4 , "Oleg" , "tkach" , "Dmytrovich" , "kuivska" , "0975601447"),
